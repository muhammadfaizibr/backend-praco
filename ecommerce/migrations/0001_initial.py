    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.SlugField(help_text='URL-friendly identifier, auto-generated if blank', max_length=255)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('show_units_per', models.CharField(choices=[('pack', 'Pack Only'), ('pallet', 'Pallet Only'), ('both', 'Both Pack and Pallet')], default='pack', max_length=10)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
