# Generated by Django 5.2 on 2025-05-08 07:58
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('height_in_inches', models.DecimalField(blank=True, decimal_places=2, editable=False, help_text='Height converted to inches (automatically calculated).', max_digits=10, null=True)),
                ('width_in_inches', models.DecimalField(blank=True, decimal_places=2, editable=False, help_text='Width converted to inches (automatically calculated).', max_digits=10, null=True)),
                ('length_in_inches', models.DecimalField(blank=True, decimal_places=2, editable=False, help_text='Length converted to inches (automatically calculated).', max_digits=10, null=True)),
            ],
            options={
                'verbose_name': 'item',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('units_per_pallet', models.PositiveIntegerField(blank=True, default=0, help_text='Number of units per pallet')),
                ('show_units_per', models.CharField(choices=[('pack', 'Pack'), ('both', 'Both (Pack & Pallet)')], default='pack', max_length=10)),
                ('status', models.CharField(choices=[('draft', 'Draft'), ('active', 'Active')], default='draft', editable=False, max_length=10)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
